...
const AddHighSchoolEdit = ({ showHide, highSc, dataIndex, ymd }) => {
  ...
  useEffect(() => {
    const data = user.high_school.find((item, i) => i === dataIndex);
    setInput({ ...data });
  }, [user, dataIndex]);
...
export default AddHighSchoolEdit;
